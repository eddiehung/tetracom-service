class UsersController < ApplicationController
	...
	def index
		...
		@users = params[:search] ? User.search(params[:search]).order("created_at DESC").paginate(:per_page => 20, page: params[:page], :order => 'name') : User.paginate(:per_page => 20, page: params[:page], :order => 'name')
	end
